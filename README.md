        ...
        <form id="quizForm">
            ...
            <script>
                const questions = [
                    ...
                    { q: "What is the correct patient care transfer process?", a: "a", options: ["Provide a comprehensive verbal report to the receiving provider.", "Leave the patient once at the facility entrance.", "Only hand over written documentation.", "Give a brief summary and leave quickly."] },
                    { q: "Which term means toward the middle of the body?", a: "b", options: ["Lateral", "Medial", "Proximal", "Superior"] },
                    ...
                    { q: "What is the normal percentage of oxygen in inhaled air?", a: "a", options: ["21%", "16%", "5%", "30%"] },
                    { q: "Which bone is also known as the kneecap?", a: "b", options: ["Tibia", "Patella", "Femur", "Calcaneus"] },
                    { q: "Which medical term describes the mechanical process of air moving in and out of the lungs?", a: "c", options: ["Respiration", "Diffusion", "Ventilation", "Circulation"] },
                    { q: "How should an EMT assess circulation in a primary assessment?", a: "b", options: ["Only check the pulse", "Assess pulse, skin condition, and major bleeding", "Rely on capillary refill only", "Check blood pressure and move on"] },
                    ...
                    { q: "What does the term 'diaphoretic' mean?", a: "c", options: ["Red skin", "Cold extremities", "Profuse sweating", "Pale skin"] },
